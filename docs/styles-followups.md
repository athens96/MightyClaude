...
`docs/i18n.md`, `docs/styles-followups.md`, `native/macos/Sources/MightyCore/ToolkitEntry.swift`, `native/macos/Sources/MightyCore/ToolkitProbe.swift`, `native/macos/Sources/MightyCore/ToolkitRunner.swift`, `native/macos/Sources/MightyCore/ToolkitStore.swift`, `native/macos/Tests/MightyCoreTests/ToolkitManifestTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitPlatformTests.swift`, `native/windows/MightyClaude.Core.Tests/SettingsSectionsVerification.cs`, `native/windows/MightyClaude.Core.Tests/ToolkitVerification.cs`, `native/windows/MightyClaude.Core.Tests/Verification.cs`, `native/windows/MightyClaude.Core/ComponentSection.cs`, `native/windows/MightyClaude.Core/SettingsSections.cs`, `native/windows/MightyClaude.Core/ToolkitFileReader.cs`, `native/windows/MightyClaude.Core/ToolkitProbe.cs`, `native/windows/MightyClaude.Core/ToolkitRunner.cs`, `native/windows/MightyClaude.Core/ToolkitStore.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Settings.cs`, `scripts/verify-windows-components.sh` — v5 열한 번째 항목. Components 칸을 Windows에 등록하고, CLI 줄·도구 목록·설치 흐름을 WinUI에 구현했다. macOS 쪽은 winget 표와 다른 OS 항목 보존이고, Windows 쪽은 도구 모음 저장소·실행기·조사와 구성 요소 칸이다. `scripts/verify-windows-components.sh`가 로케일 관문과 Core 테스트를 한 번에 돌려 DELIVERED_OK를 찍는다. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.
