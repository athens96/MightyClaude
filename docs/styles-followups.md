...
`docs/i18n.md`, `docs/mighty-mode.md`, `docs/styles-followups.md`, `locales/en.json`, `locales/ko.json`, `mobile/src/locales/en.json`, `mobile/src/locales/ko.json`, `native/macos/Sources/MightyClaude/AppStore+GraphResize.swift`, `native/macos/Sources/MightyClaude/MightyGraphView.swift`, `native/macos/Sources/MightyClaude/SessionPaneView.swift`, `native/macos/Sources/MightyCore/MightyGraphCamera.swift`, `native/macos/Sources/MightyCore/MightyGraphLayout.swift`, `native/macos/Sources/MightyCore/Models.swift`, `native/macos/Sources/MightyCore/Resources/Locales/en.json`, `native/macos/Sources/MightyCore/Resources/Locales/ko.json`, `native/macos/Sources/MightyCore/StateRepository.swift`, `native/macos/Tests/MightyCoreTests/ActivityTests.swift`, `native/macos/Tests/MightyCoreTests/AppUpdateTests.swift`, `native/macos/Tests/MightyCoreTests/AttachmentTests.swift`, `native/macos/Tests/MightyCoreTests/CLIEnvironmentTests.swift`, `native/macos/Tests/MightyCoreTests/CLIUpdateTests.swift`, `native/macos/Tests/MightyCoreTests/ClaudePluginTests.swift`, `native/macos/Tests/MightyCoreTests/CodexApprovalRunnerTests.swift`, `native/macos/Tests/MightyCoreTests/CodexPluginTests.swift`, `native/macos/Tests/MightyCoreTests/CoreTests.swift`, `native/macos/Tests/MightyCoreTests/ExecutionGraphTests.swift`, `native/macos/Tests/MightyCoreTests/MightyGraphLayoutTests.swift`, `native/macos/Tests/MightyCoreTests/ModelRefreshTests.swift`, `native/macos/Tests/MightyCoreTests/PermissionTests.swift`, `native/macos/Tests/MightyCoreTests/RemoteTests.swift`, `native/macos/Tests/MightyCoreTests/SessionUsageTests.swift` — v5 네 번째 항목. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.
...
`.gitignore`, `docs/browser-pane.md`, `docs/i18n.md`, `docs/styles-followups.md`, `locales/en.json`, `locales/ko.json`, `mobile/src/locales/en.json`, `mobile/src/locales/ko.json`, `native/macos/BrowserEngine.lock`, `native/macos/Sources/MightyClaude/AppStore.swift`, `native/macos/Sources/MightyClaude/BrowserPaneView.swift`, `native/macos/Sources/MightyClaude/PaneDockView.swift`, `native/macos/Sources/MightyClaude/WorkspaceView.swift`, `native/macos/Sources/MightyCore/BrowserEngine.swift`, `native/macos/Sources/MightyCore/Models.swift`, `native/macos/Sources/MightyCore/Resources/Locales/en.json`, `native/macos/Sources/MightyCore/Resources/Locales/ko.json`, `native/macos/Sources/MightyCore/StateRepository.swift`, `native/macos/Tests/MightyCoreTests/BrowserEngineTests.swift`, `native/macos/Tests/MightyCoreTests/BrowserSessionTests.swift`, `native/windows/MightyClaude.Core.Tests/BrowserSessionVerification.cs`, `native/windows/MightyClaude.Core.Tests/Verification.cs`, `scripts/build-macos.sh`, `scripts/fetch-browser-engine.sh` — v5 다섯 번째 항목. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.

### 페이즈별 모델 라우팅 (시드 `ac_bab76e99eb31e8f4`)

`docs/i18n.md`, `docs/model-defaults.md`, `docs/phase-model-routing.md`, `docs/styles-followups.md`, `locales/en.json`, `locales/ko.json`, `native/macos/Sources/MightyCore/GraphModelLabel.swift`, `native/macos/Sources/MightyCore/ModelDefaultsResolution.swift`, `native/macos/Sources/MightyCore/ModelSettingsFileStore.swift`, `native/macos/Sources/MightyCore/Models.swift`, `native/macos/Sources/MightyCore/PhaseModelRouting.swift`, `native/macos/Sources/MightyCore/ProviderService.swift`, `native/macos/Sources/MightyCore/Resources/Locales/en.json`, `native/macos/Sources/MightyCore/Resources/Locales/ko.json`, `native/macos/Sources/MightyClaude/AppStore.swift`, `native/macos/Sources/MightyClaude/AppStore+ModelDefaults.swift`, `native/macos/Sources/MightyClaude/AppStore+PhaseModels.swift`, `native/macos/Sources/MightyClaude/ModelDefaultsSettingsView.swift`, `native/macos/Sources/MightyClaude/PhaseModelSettingsView.swift`, `native/macos/Sources/MightyClaude/SessionPaneView.swift`, `native/macos/Sources/MightyClaude/SettingsViews.swift`, `native/macos/Tests/MightyCoreTests/ModelDefaultsProductionPathTests.swift`, `native/macos/Tests/MightyCoreTests/ModelDefaultsTests.swift`, `native/macos/Tests/MightyCoreTests/ModelSettingsFileTests.swift`, `native/macos/Tests/MightyCoreTests/PhaseModelLaunchTests.swift`, `native/macos/Tests/MightyCoreTests/PhaseModelMacReplacedTests.swift`, `native/macos/Tests/MightyCoreTests/PhaseModelRoutingTests.swift`, `native/windows/MightyClaude.Core.Tests/ModelDefaultsVerification.cs`, `native/windows/MightyClaude.Core.Tests/SettingsSectionsVerification.cs`, `native/windows/MightyClaude.Core.Tests/Verification.cs`, `native/windows/MightyClaude.Core/ModelDefaultsResolution.cs`, `native/windows/MightyClaude.Core/ModelDefaultsStrings.cs`, `native/windows/MightyClaude.Core/Models.cs`, `native/windows/MightyClaude.Core/SettingsSections.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Composer.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Settings.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Smoke.cs`, `native/windows/MightyClaude.WinUI/MainWindow.cs` — v5 일곱 번째 항목. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.

### 브라우저 창 1b단계 (시드 `seed_browser_s1b_live_pane`)

`docs/browser-pane.md`, `docs/i18n.md`, `docs/styles-followups.md`, `native/macos/Sources/MightyClaude/BrowserContainerView.swift`, `native/macos/Sources/MightyClaude/BrowserPaneView.swift`, `native/macos/Sources/MightyClaude/CefBrowserEngine.swift`, `native/macos/Sources/MightyClaude/MightyApplication.swift`, `native/macos/Sources/MightyCore/BrowserAddress.swift`, `native/macos/Sources/MightyCore/BrowserEngine.swift`, `native/macos/Sources/MightyCore/BrowserHistory.swift`, `native/macos/Sources/MightyCore/BrowserNavigationState.swift`, `native/macos/Tests/MightyCoreTests/BrowserAddressTests.swift`, `native/macos/Tests/MightyCoreTests/BrowserProfileTests.swift`, `scripts/build-macos.sh` — v5 여섯 번째 항목. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.

### 내 작업 도구 모음 (시드 `seed_toolkit_autoinstall`)

`docs/i18n.md`, `docs/mighty-styles.md`, `docs/styles-followups.md`, `docs/toolkit.md`, `locales/en.json`, `locales/ko.json`, `mobile/src/locales/en.json`, `mobile/src/locales/ko.json`, `native/macos/Sources/MightyClaude/AppStore+Toolkit.swift`, `native/macos/Sources/MightyClaude/AppStore.swift`, `native/macos/Sources/MightyClaude/ComponentsSettingsView.swift`, `native/macos/Sources/MightyClaude/SettingsViews.swift`, `native/macos/Sources/MightyCore/Resources/Locales/en.json`, `native/macos/Sources/MightyCore/Resources/Locales/ko.json`, `native/macos/Sources/MightyCore/Styles/StyleEvaluator.swift`, `native/macos/Sources/MightyCore/ToolkitEntry.swift`, `native/macos/Sources/MightyCore/ToolkitProbe.swift`, `native/macos/Sources/MightyCore/ToolkitRunner.swift`, `native/macos/Sources/MightyCore/ToolkitStore.swift`, `native/macos/Tests/MightyCoreTests/StylesOuroborosTests.swift`, `native/macos/Tests/MightyCoreTests/StylesPaperthinTests.swift`, `native/macos/Tests/MightyCoreTests/StylesThirdPartyOhMyClaudecodeTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitManifestTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitProbeTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitRunnerTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitStoreTests.swift`, `native/windows/MightyClaude.Core.Tests/ToolkitFileVerification.cs`, `native/windows/MightyClaude.Core.Tests/Verification.cs`, `native/windows/MightyClaude.Core/ToolkitFileReader.cs` — v5 여덟 번째 항목. `a44f9ae` 이후 이 시드가 건드린 경로 전부다. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.
...
### Windows 2차 2단계: 단계별 모델 (시드 `seed_windows_b2_s2_phase_models`)

`docs/i18n.md`, `docs/phase-model-routing.md`, `docs/styles-followups.md`, `docs/windows-parity.md`, `docs/windows-screen-checklist.md`, `locales/en.json`, `locales/ko.json`, `mobile/src/locales/en.json`, `mobile/src/locales/ko.json`, `native/macos/Sources/MightyClaude/AppStore+PhaseModels.swift`, `native/macos/Sources/MightyClaude/AppStore.swift`, `native/macos/Sources/MightyClaude/PhaseModelSettingsView.swift`, `native/macos/Sources/MightyCore/ModelSettingsFileStore.swift`, `native/macos/Sources/MightyCore/OmcAgentCatalog.swift`, `native/macos/Sources/MightyCore/Resources/Locales/en.json`, `native/macos/Sources/MightyCore/Resources/Locales/ko.json`, `native/macos/Tests/MightyCoreTests/OmcAgentCatalogTests.swift`, `native/macos/Tests/MightyCoreTests/PhaseModelSaveTests.swift`, `native/windows/MightyClaude.Core.Tests/PhaseModelVerification.cs`, `native/windows/MightyClaude.Core.Tests/SettingsSectionsVerification.cs`, `native/windows/MightyClaude.Core.Tests/Verification.cs`, `native/windows/MightyClaude.Core/ModelSettingsFileStore.cs`, `native/windows/MightyClaude.Core/Models.cs`, `native/windows/MightyClaude.Core/OmcAgentCatalog.cs`, `native/windows/MightyClaude.Core/PhaseModelRouting.cs`, `native/windows/MightyClaude.Core/PhaseModelSection.cs`, `native/windows/MightyClaude.Core/ProviderCatalog.cs`, `native/windows/MightyClaude.Core/SettingsSections.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Settings.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Smoke.cs` — v5 열 번째 항목. `972c334` 이후 이 시드가 건드린 경로 전부다(macOS 배선, Windows Core, Windows 설정 칸·스모크, 문서). 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.

### Windows 2차 3단계: 구성 요소 화면 (시드 `interview_20260924_153901`)

`docs/i18n.md`, `docs/styles-followups.md`, `native/macos/Sources/MightyCore/ToolkitEntry.swift`, `native/macos/Sources/MightyCore/ToolkitProbe.swift`, `native/macos/Sources/MightyCore/ToolkitRunner.swift`, `native/macos/Sources/MightyCore/ToolkitStore.swift`, `native/macos/Tests/MightyCoreTests/ToolkitManifestTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitPlatformTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitSharedFormatTests.swift`, `native/windows/MightyClaude.Core.Tests/SettingsSectionsVerification.cs`, `native/windows/MightyClaude.Core.Tests/ToolkitVerification.cs`, `native/windows/MightyClaude.Core.Tests/Verification.cs`, `native/windows/MightyClaude.Core/ComponentSection.cs`, `native/windows/MightyClaude.Core/SettingsSections.cs`, `native/windows/MightyClaude.Core/ToolkitFileReader.cs`, `native/windows/MightyClaude.Core/ToolkitProbe.cs`, `native/windows/MightyClaude.Core/ToolkitRunner.cs`, `native/windows/MightyClaude.Core/ToolkitStore.cs`, `native/windows/MightyClaude.WinUI/MainWindow.Settings.cs`, `scripts/verify-shared-format.sh`, `scripts/verify-windows-components.sh` — v5 열한 번째 항목. Components 칸을 Windows에 등록하고, CLI 줄·도구 목록·설치 흐름을 WinUI에 구현했다. macOS 쪽은 winget 표와 다른 OS 항목 보존이고, Windows 쪽은 도구 모음 저장소·실행기·조사와 구성 요소 칸이다. `ToolkitSharedFormatTests`와 Windows `shared-format` 두 테스트가 brew·npm·winget 항목을 담은 공통 픽스처를 써서 두 플랫폼이 같은 파일을 읽음을 증명한다(`scripts/check-winui-compile.sh`, `scripts/verify-shared-format.sh` → SHARED_FORMAT_OK). `scripts/verify-windows-components.sh`가 로케일 관문, WinUI C# 컴파일(`scripts/check-winui-compile.sh`), Core 테스트를 한 번에 돌려 DELIVERED_OK를 찍는다. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.
