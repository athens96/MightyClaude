...
### 내 작업 도구 모음 (시드 `ac_bf091c1131a06c78`)

`docs/i18n.md`, `docs/mighty-styles.md`, `docs/styles-followups.md`, `docs/toolkit.md`, `locales/en.json`, `locales/ko.json`, `mobile/src/locales/en.json`, `mobile/src/locales/ko.json`, `native/macos/Sources/MightyCore/Resources/Locales/en.json`, `native/macos/Sources/MightyCore/Resources/Locales/ko.json`, `native/macos/Sources/MightyCore/ToolkitEntry.swift`, `native/macos/Sources/MightyCore/ToolkitProbe.swift`, `native/macos/Sources/MightyCore/ToolkitRunner.swift`, `native/macos/Sources/MightyCore/ToolkitStore.swift`, `native/macos/Sources/MightyClaude/AppStore.swift`, `native/macos/Sources/MightyClaude/AppStore+Toolkit.swift`, `native/macos/Sources/MightyClaude/ComponentsSettingsView.swift`, `native/macos/Sources/MightyClaude/SettingsViews.swift`, `native/macos/Tests/MightyCoreTests/ToolkitManifestTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitProbeTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitRunnerTests.swift`, `native/macos/Tests/MightyCoreTests/ToolkitStoreTests.swift`, `native/windows/MightyClaude.Core.Tests/ToolkitFileVerification.cs`, `native/windows/MightyClaude.Core/ToolkitFileReader.cs` — v5 여덟 번째 항목. 이 경로들도 v5 태그 전까지 `scripts/check-style-freeze.sh`의 exit 1에 포함되는 것이 정상이다.
