...
| 권한 모드 | `ToolPermissions.swift`, `ToolPermissionPresentation.swift`, `ToolPermissionBar.swift` | `RunSettings.PermissionMode`; `AutoPermissionVerification.cs` — 구현됨 | 이미 있음 | 권한 모드 열거 및 자동 모드 구현됨 | |
