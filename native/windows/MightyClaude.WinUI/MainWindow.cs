...
public sealed partial class MainWindow : Window
{
    ...
    private sealed partial class PaneView
    {
        ...
        internal PaneView(MainWindow owner, string id)
        {
            ...
            var composer = new StackPanel { Spacing = 7 }; attachmentChips.Visibility = Visibility.Collapsed; composer.Children.Add(attachmentChips); composer.Children.Add(input); composer.Children.Add(bottom); composer.Children.Add(permissionHint); composer.Children.Add(inputHint);
